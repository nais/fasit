...
require (
	...
	github.com/GoogleCloudPlatform/k8s-config-connector v1.109.0
	...
	github.com/pressly/goose/v3 v3.11.1
...
require (
	...
	go.starlark.net v0.0.0-20230911222709-95963e010017 // indirect
