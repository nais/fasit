...
type ComplexityRoot struct {
	...
	Query struct {
		...
		Values        func(childComplexity int, feature string, env model.ID) int
	}
}
...
type QueryResolver interface {
	...
	Values(ctx context.Context, feature string, env model.ID) (map[string]interface{}, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.values":
		...
		return e.complexity.Query.Values(childComplexity, args["feature"].(string), args["env"].(model.ID)), true
...
func (ec *executionContext) field_Query_values_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["env"]; ok {
		...
		arg1, err = ec.unmarshalNID2githubᚗcomᚋnaisᚋfasitᚋpkgᚋgraphᚋmodelᚐID(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Configuration_id(ctx context.Context, field graphql.CollectedField, obj *model.Configuration) (ret graphql.Marshaler) {
	...
	res := resTmp.(model.ID)
	fc.Result = res
	return ec.marshalNID2githubᚗcomᚋnaisᚋfasitᚋpkgᚋgraphᚋmodelᚐID(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Configuration_environmentID(ctx context.Context, field graphql.CollectedField, obj *model.Configuration) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.ID)
	fc.Result = res
	return ec.marshalOID2ᚖgithubᚗcomᚋnaisᚋfasitᚋpkgᚋgraphᚋmodelᚐID(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_values(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Values(rctx, args["feature"].(string), args["env"].(model.ID))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputEnvironmentCreate(ctx context.Context, obj interface{}) (model.EnvironmentCreate, error) {
	...
	for k, v := range asMap {
		...
		case "partnerID":
			...
			it.PartnerID, err = ec.unmarshalNID2githubᚗcomᚋnaisᚋfasitᚋpkgᚋgraphᚋmodelᚐID(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) unmarshalInputNewConfiguration(ctx context.Context, obj interface{}) (model.NewConfiguration, error) {
	...
	for k, v := range asMap {
		...
		case "environmentID":
			...
			it.EnvironmentID, err = ec.unmarshalOID2ᚖgithubᚗcomᚋnaisᚋfasitᚋpkgᚋgraphᚋmodelᚐID(ctx, v)
			if err != nil {
				return it, err
			}
		case "feature":
...
func (ec *executionContext) unmarshalNID2githubᚗcomᚋnaisᚋfasitᚋpkgᚋgraphᚋmodelᚐID(ctx context.Context, v interface{}) (model.ID, error) {
	res, err := graph.UnmarshalID(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNID2githubᚗcomᚋnaisᚋfasitᚋpkgᚋgraphᚋmodelᚐID(ctx context.Context, sel ast.SelectionSet, v model.ID) graphql.Marshaler {
	res := graph.MarshalID(v)
	if res == graphql.Null {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalOID2ᚖgithubᚗcomᚋnaisᚋfasitᚋpkgᚋgraphᚋmodelᚐID(ctx context.Context, v interface{}) (*model.ID, error) {
	if v == nil {
		return nil, nil
	}
	res, err := graph.UnmarshalID(v)
...
func (ec *executionContext) marshalOID2ᚖgithubᚗcomᚋnaisᚋfasitᚋpkgᚋgraphᚋmodelᚐID(ctx context.Context, sel ast.SelectionSet, v *model.ID) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	res := graph.MarshalID(*v)
