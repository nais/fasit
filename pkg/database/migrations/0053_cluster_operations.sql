...
CREATE TABLE cluster_operations (
    ...
    CONSTRAINT fk_cluster_operations_tenant
      FOREIGN KEY (tenant_id)
          REFERENCES tenants (id) ON DELETE CASCADE,
    CONSTRAINT fk_cluster_operations_env
      FOREIGN KEY (environment_id)
          REFERENCES environments (id) ON DELETE CASCADE,
    CONSTRAINT fk_cluster_operations_version
      FOREIGN KEY (upgrade_id)
          REFERENCES cluster_upgrades (id) ON DELETE CASCADE
);
