...
// RolloutEventsGetByRolloutID provides a mock function with given fields: ctx, rolloutID
func (_m *Querier) RolloutEventsGetByRolloutID(ctx context.Context, rolloutID uuid.UUID) ([]gensql.RolloutEvent, error) {
	ret := _m.Called(ctx, rolloutID)
...
// RolloutEventsGetByRolloutIDAndType provides a mock function with given fields: ctx, arg
func (_m *Querier) RolloutEventsGetByRolloutIDAndType(ctx context.Context, arg gensql.RolloutEventsGetByRolloutIDAndTypeParams) ([]gensql.RolloutEvent, error) {
	ret := _m.Called(ctx, arg)

	var r0 []gensql.RolloutEvent
	if rf, ok := ret.Get(0).(func(context.Context, gensql.RolloutEventsGetByRolloutIDAndTypeParams) []gensql.RolloutEvent); ok {
		r0 = rf(ctx, arg)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]gensql.RolloutEvent)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, gensql.RolloutEventsGetByRolloutIDAndTypeParams) error); ok {
		r1 = rf(ctx, arg)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Querier) RolloutSummaryCreate(ctx context.Context, feature string) (gensql.RolloutSummary, error) {
	...
	var r0 gensql.RolloutSummary
	if rf, ok := ret.Get(0).(func(context.Context, string) gensql.RolloutSummary); ok {
		r0 = rf(ctx, feature)
	} else {
		r0 = ret.Get(0).(gensql.RolloutSummary)
	}
...
// RolloutSummaryDone provides a mock function with given fields: ctx, rolloutSummaryID
func (_m *Querier) RolloutSummaryDone(ctx context.Context, rolloutSummaryID uuid.UUID) (bool, error) {
	ret := _m.Called(ctx, rolloutSummaryID)

	var r0 bool
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) bool); ok {
		r0 = rf(ctx, rolloutSummaryID)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
// RolloutsBySummaryID provides a mock function with given fields: ctx, rolloutSummaryID
func (_m *Querier) RolloutsBySummaryID(ctx context.Context, rolloutSummaryID uuid.UUID) ([]gensql.Rollout, error) {
	ret := _m.Called(ctx, rolloutSummaryID)
