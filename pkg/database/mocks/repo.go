...
func (_m *Repo) HelmValues(ctx context.Context, _a1 feature.Feature, envID uuid.UUID) (map[string]interface{}, []uuid.UUID, error) {
	ret := _m.Called(ctx, _a1, envID)
	...
	var r1 []uuid.UUID
	if rf, ok := ret.Get(1).(func(context.Context, feature.Feature, uuid.UUID) []uuid.UUID); ok {
		r1 = rf(ctx, _a1, envID)
	} else {
		if ret.Get(1) != nil {
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(context.Context, feature.Feature, uuid.UUID) error); ok {
		r2 = rf(ctx, _a1, envID)
	} else {
		r2 = ret.Error(2)
	}
...
// RolloutEventCreate provides a mock function with given fields: ctx, event
func (_m *Repo) RolloutEventCreate(ctx context.Context, event *model.RolloutEvent) error {
	ret := _m.Called(ctx, event)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *model.RolloutEvent) error); ok {
		r0 = rf(ctx, event)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Repo) RolloutEventsGetByRolloutID(ctx context.Context, rolloutID uuid.UUID) ([]*model.RolloutEvent, error) {
	ret := _m.Called(ctx, rolloutID)
